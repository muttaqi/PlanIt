...
public class ScheduleTableAdapter extends AbstractTableAdapter<String, String, String> {
    ...
    class MyCellViewHolder extends AbstractViewHolder {
        ...
        public MyCellViewHolder(View itemView) {
            super(itemView);
            cell_textview = (TextView) itemView.findViewById(R.id.tv_item_schedule_member);
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateCellViewHolder(ViewGroup parent, int viewType) {
        // Get cell xml layout
        View layout = LayoutInflater.from(m_jContext).inflate(R.layout.schedule_member_list_item,
                parent, false);
    ...
    public void onBindCellViewHolder(AbstractViewHolder holder, Object p_jValue, int
        ...
        for(AbstractViewHolder h : holders) {
            ...
            h.itemView.setBackgroundColor(c.getResources().getColor(R.color.colorPrimary));
        }
    ...
    class MyColumnHeaderViewHolder extends AbstractViewHolder {
        ...
        public MyColumnHeaderViewHolder(View itemView) {
            super(itemView);
            column_textview = (TextView) itemView.findViewById(R.id.tv_item_schedule_job);
        }
    ...
    public void onBindColumnHeaderViewHolder(AbstractViewHolder holder, Object p_jValue, int
        ...
        // It is necessary to remeasure itself.
        columnHeaderViewHolder.column_textview.setTextColor(c.getResources().getColor(R.color.white));
        columnHeaderViewHolder.itemView.setBackgroundColor(c.getResources().getColor(R.color.colorPrimary));
    ...
    class MyRowHeaderViewHolder extends AbstractViewHolder {
        ...
        public MyRowHeaderViewHolder(View itemView) {
            super(itemView);
            row_textview = (TextView) itemView.findViewById(R.id.tv_item_schedule_timeslot);
        }
    }
    ...
    public void onBindRowHeaderViewHolder(AbstractViewHolder holder, Object p_jValue, int
        ...
        rowHeaderViewHolder.row_textview.setTextColor(c.getResources().getColor(R.color.white));
        rowHeaderViewHolder.row_textview.setBackgroundColor(c.getResources().getColor(R.color.colorPrimary));
        rowHeaderViewHolder.itemView.getLayoutParams().height = LinearLayout
                .LayoutParams.WRAP_CONTENT;
        rowHeaderViewHolder.itemView.getLayoutParams().width = LinearLayout
                .LayoutParams.WRAP_CONTENT;
    ...
    public View onCreateCornerView() {
        ...
        return LayoutInflater.from(m_jContext).inflate(R.layout.schedule_corner, null);
    }
