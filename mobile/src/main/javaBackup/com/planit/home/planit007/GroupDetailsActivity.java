...
import com.planit007.Adapters.MemberAdapter;
...
public class GroupDetailsActivity extends AppCompatActivity implements MemberAdapter.MemberAdapterOnClickHandler, EventAdapter.EventAdapterOnClickHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(planit.planit.home.planit003.R.layout.activity_group_details);

        mAdView = findViewById(planit.planit.home.planit003.R.id.gd_ad);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        titleMemberRv = (TextView) findViewById(planit.planit.home.planit003.R.id.gd_tv_member_title);
        titleEventRv = (TextView) findViewById(planit.planit.home.planit003.R.id.gd_tv_event_title);

        Intent intent = getIntent();

        groupID = intent.getIntExtra("groupID", 0);

        mMembersList = (RecyclerView) findViewById(planit.planit.home.planit003.R.id.gd_rv_members);
        mEventsList = (RecyclerView) findViewById(planit.planit.home.planit003.R.id.gd_rv_events);
        ...
        Log.d(TAG, "DEBUG GDA 78 " + String.valueOf(groupID));
        ...
        if(groupCursor.moveToFirst() && groupCursor != null) {
            ...
            Log.d(TAG, "DEBUG GDA 91 " + String.valueOf(groupCursor.getString(groupCursor.getColumnIndex(GroupContract.GroupEntry.COLUMN_GROUP_NAME))));
        }

        tvGroupName = (TextView) findViewById(planit.planit.home.planit003.R.id.gd_tv_group_name);
        ...
        txtNullMember = (TextView) findViewById(planit.planit.home.planit003.R.id.gd_tv_member_null);
        txtNullEvent = (TextView) findViewById(planit.planit.home.planit003.R.id.gd_tv_event_null);
        ...
        famGDA = (FloatingActionMenu) findViewById(planit.planit.home.planit003.R.id.gd_fam);

        findViewById(planit.planit.home.planit003.R.id.gd_fab_add_member).setOnClickListener(new View.OnClickListener() {
        ...
        findViewById(planit.planit.home.planit003.R.id.gd_fab_add_event).setOnClickListener(new View.OnClickListener() {
        ...
        findViewById(planit.planit.home.planit003.R.id.gd_iv_name).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    public void createEventNamePrompt() {
    }

    public void createMemberNamePrompt() {
    ...
    public void onClickEvent(int event_id, int group_id) {
        ...
        Log.d(TAG, "DEBUG GDA 353 ONCLICKEVENT");
        ...
        Log.d(TAG, "DEBUG GDA 372 " + groupID);
